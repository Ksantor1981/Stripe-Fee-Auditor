...
export async function generateMetadata(): Promise<Metadata> {
  return seoPageMetadata("shouldSwitch", pagePath);
}

export default async function Page() {
  const t = await getTranslations("seo.shouldSwitch");
  const faqJsonLd = await seoPageFaqJsonLd("shouldSwitch");
