...
export async function generateMetadata(): Promise<Metadata> {
  return seoPageMetadata("vsSquare", pagePath);
}

export default async function Page() {
  const t = await getTranslations("seo.vsSquare");
  const faqJsonLd = await seoPageFaqJsonLd("vsSquare");
