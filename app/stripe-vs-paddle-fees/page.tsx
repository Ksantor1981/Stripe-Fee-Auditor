...
export async function generateMetadata(): Promise<Metadata> {
  return seoPageMetadata("vsPaddle", pagePath);
}

export default async function Page() {
  const t = await getTranslations("seo.vsPaddle");
  const faqJsonLd = await seoPageFaqJsonLd("vsPaddle");
