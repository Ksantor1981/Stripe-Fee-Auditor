...
export const FEE_BLOG_ENTRIES: BlogIndexEntry[] = [
  ...
  },
  {
    ...
    title: "Stripe Credit Card Fees: 2.9% + $0.30 & Your Real Rate",
    desc: "Stripe credit card fees start at 2.9% + $0.30 — most businesses pay more. See effective rate by charge size and audit your real cost from Balance CSV.",
    time: "8 min",
    publishedAt: "2026-06-25",
    updatedAt: "2026-08-19",
    sitemapPriority: 0.8,
  ...
  },
  {
    ...
    title: "Stripe International Fees: Cross-Border Costs",
    desc: "Stripe international fees add ~1.5% on cross-border cards — find international fee drag in your Balance CSV.",
    time: "6 min",
  ...
  },
  {
    ...
    title: "Stripe Fees on Small Transactions: Why $5 Costs ~9%",
    desc: "The $0.30 fixed fee dominates micro-payments — see the math and audit small-ticket drag in your Balance CSV.",
    time: "5 min",
    publishedAt: "2026-05-16",
    updatedAt: "2026-08-19",
  ...
  },
  {
    ...
    title: "How to Export Stripe Data from Dashboard (Balance CSV)",
    desc: "Export Stripe data step-by-step: Itemized Balance CSV with per-transaction fees. Avoid Summary/Payout mistakes.",
    time: "4 min",
    publishedAt: "2026-05-16",
    updatedAt: "2026-08-19",
...
export const SEO_LANDING_ENTRIES: BlogIndexEntry[] = [
  ...
  },
  {
    ...
    desc: "Calculate Stripe processing fees, net payout, and effective rate using published pricing. Include international cards, currency conversion, and fixed fees.",
    time: "5 min",
    publishedAt: "2026-06-25",
    updatedAt: "2026-08-19",
    sitemapPriority: 0.8,
  },
  {
    ...
    title: "What Percent Does Stripe Take? (2026 Rates)",
    desc: "What percent does Stripe take? For many US online cards it starts at 2.9% + $0.30. See the effective percentage by ticket size, then audit actual fees from CSV.",
    time: "4 min",
    publishedAt: "2026-06-25",
    updatedAt: "2026-08-19",
  ...
  },
  {
    ...
    title: "How to Export Stripe Data (CSV, JSON, Tableau & More)",
    desc: "Export Stripe data for accounting, BI, or fee audits. Compare CSV, JSON, Tableau, PostgreSQL paths — then reconcile fees from Balance CSV.",
    time: "5 min",
  ...
  },
  {
    ...
    title: "Export Stripe Data: Balance CSV Guide for Fee Audit",
    desc: "How to export Stripe data as an itemized Balance CSV — with fees per transaction. Then audit effective rate, refunds, and international cards.",
    time: "4 min",
    publishedAt: "2026-06-25",
    updatedAt: "2026-08-19",
    sitemapPriority: 0.7,
