...
export const SEO_LANDING_ENTRIES: BlogIndexEntry[] = [
  ...
  },
  {
    ...
    title: "How Much Does Stripe Charge Per Transaction?",
    desc: "How much does Stripe charge per transaction? Start at 2.9% + $0.30 for many US cards, then check your real blended percentage from Balance CSV.",
    time: "4 min",
    publishedAt: "2026-06-25",
