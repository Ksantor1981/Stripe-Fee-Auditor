...
export const SEO_LANDING_ENTRIES: BlogIndexEntry[] = [
  ...
  },
  {
    ...
    title: "Stripe Fees Calculator: Estimate Monthly Fees",
    desc: "Free Stripe fees calculator for monthly volume and average charge size. See how much Stripe charges per transaction, then verify your real rate from CSV.",
    time: "5 min",
    publishedAt: "2026-06-25",
