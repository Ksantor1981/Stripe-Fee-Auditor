...
export async function generateMetadata(): Promise<Metadata> {
  return seoPageMetadata("analysisTools", pagePath);
}

export default async function Page() {
  const t = await getTranslations("seo.analysisTools");
  const faqJsonLd = await seoPageFaqJsonLd("analysisTools");
