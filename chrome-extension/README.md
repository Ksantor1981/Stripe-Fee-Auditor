...
- **Quick fee estimate** in the popup (same published-rate math as `/stripe-fee-calculator`)
...
Logic lives in `fee-calculator.js` (mirrors `lib/stripe-country-fees.ts` + `components/stripe-fee-mini-estimate.tsx`).
