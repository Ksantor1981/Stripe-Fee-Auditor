...
const pageTitle = "Is Square or Stripe Cheaper? Fees Compared";
...
const config: ProviderComparisonConfig = {
  ...
  h1: "Is Square or Stripe cheaper? Compare fees and business fit.",
  intro:
  ...
  heroTitle: "Cheaper depends on how you accept payments.",
  heroBody:
